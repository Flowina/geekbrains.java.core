...
public class DataBaseRepository {
    private String insertWeather = "insert into weatherForecasts (city, localdate,weatherText, temperature) values (?, ?, ?, ?)";
    private String getWeather = "select * from weatherForecasts";
